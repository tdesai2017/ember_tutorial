...
module('Integration | Component | map', function(hooks) {
  ...
  // Tests that the 'src' attribute of a map is accuratley updated
  test('it updates the `src` attribute when the arguments change', async function(assert) {
    // Allows us to manually change these values
    // setProperties's "this" is referring to a "test context object" that we will have access to within "renders"
    this.setProperties({
      lat: 37.7749,
      lng: -122.4194,
      zoom: 10,
